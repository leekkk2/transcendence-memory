...
- local live ops fact: current online unit is `rag-everything.service`
...
When documenting or operating against local production reality, use `rag-everything.service` as the current live unit name.
